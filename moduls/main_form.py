...
"}")
        ...
        self.tabWidget.addTab(self.tab_2, "Фото RGB")
        ...
        self.tabWidget.addTab(self.tab_4, "Сохранения данных")
        ...
        MainWindow.setTabOrder(self.tableWidget, self.graphicsView)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_5.setText(_translate("MainWindow", "Найти пользователя"))
        self.pushButton_2.setText(_translate("MainWindow", "Приступить к фотографированию"))
        self.pushButton_11.setText(_translate("MainWindow", "Обучить базу"))
        self.pushButton_6.setText(_translate("MainWindow", "Отправить базу на станцию"))
        self.pushButton_7.setText(_translate("MainWindow", "Открыть папку с базой"))
